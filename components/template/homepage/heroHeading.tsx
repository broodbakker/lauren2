...
import { GiPresent, GiHorseshoe } from "react-icons/gi";
      ...
      <Stack
        ...
        <Stack flex={1} spacing={{ base: 5, md: 10 }}>
          ...
          <Stack
            ...
            <NextLink href="/winkel/paarden/1">
              <Button
                as="a"
                cursor="pointer"
                rounded={'full'}
              ...
              >
                Bekijk mijn spulletjes
              </Button>
            </NextLink>

            <NextLink href="/over-mij">
              <Button
                rounded={'full'}
                size={'lg'}
                fontWeight={'normal'}
                px={6}
                leftIcon={<GiHorseshoe height={4} width={4} color={'gray.300'} />}>
                Iets over mij
              </Button>
            </NextLink>
          </Stack>
